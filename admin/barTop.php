...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    <div id="roleDisplay"></div> - <div id="nameLogued"></div>

    <!-- Boton ir al Top -->
    <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3"> <i class="fa fa-bars"></i>
    </button>

<div style=" display: block;    text-align: center; margin: auto;">   <strong>Plan: </strong> <span id="planDisplay" ></span></div>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="../superadmin/img/undraw_profile.svg">
            </a>
...
<div id="miModal" class="modalx">
    ...
    <div class="modal-contentx">
        ...
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-primary" style="    display: block;margin-left: auto;  margin-right: auto;" onclick="updateProfileUser()">Guardar cambios <i class="fas fa-check"></i></button>
